        ...
        <CRow className="justify-content-center">
            <CCardGroup>
              <CCard className="p-4">
                <CCardBody>
                  <FormArea>
                    <h2 className="mb-5">Consultar veículos</h2>
                   ...
                   <CForm onSubmit={handleSubmit()}  name='cad_veiculo'> 
                    ...
                    <CFormLabel htmlFor="marca_veiculo" className="col-sm-2 col-form-label">Fabricante<span>*</span></CFormLabel>
                            <CCol sm={4}>
                            <CFormSelect name='fabrica_veiculo' id='options'                           
                            > 
                            ...
                            <CFormLabel htmlFor="modelo_veiculo" className="col-sm-2 col-form-label">Marca Veiculo <span>*</span></CFormLabel>
                            <CCol sm={4}>
                      ...
                      <CFormLabel htmlFor="sobrenome" className="col-sm-2 col-form-label">Sobrenome <span>*</span></CFormLabel>
                          ...
                          <CFormLabel htmlFor="sobrenome" className="col-sm-2 col-form-label">Status <span>*</span></CFormLabel>
                          <CCol sm={4}>
                            <CFormSelect >
                                <option>Selecione uma opão</option>
                                <option>Ativo  </option>
