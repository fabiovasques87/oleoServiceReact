...
const ConsultaCliente = React.lazy(() => import('./views/base/consulta/cliente/ConsultaCliente'))
const ConsultaVeiculo = React.lazy(() => import('./views/base/consulta/veiculo/ConsultaVeiculo'))
